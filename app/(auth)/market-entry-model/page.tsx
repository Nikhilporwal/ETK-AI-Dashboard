...
export default function MarketEntryModelPage() {
    ...
    const [selectedStates, setSelectedStates] = useState<boolean[]>(new Array(options.length).fill(false))
            ...
            <div className="space-y-6">
              ...
              `}
                        >
                            ...
                            />
                            <span className={`text-sm font-semibold transition-colors ${selectedStates[idx] ? "text-[#203D8E]" : "text-[#4B5563]"}`}>
                                {option}
                            </span>
                        </div>
                    ))}
